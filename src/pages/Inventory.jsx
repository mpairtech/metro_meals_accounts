  ...
  return (
    <div>
              ...
              <div className="bulk-desktop-row" style={{
                ...
                <div style={{ textAlign: 'right' }}>
                  <input type="number" min="0" step="0.01"
                    ...
                    placeholder="0.00"
                    style={{
                      width: 100, border: `1.5px solid ${filled && !prices[h.id] ? 'var(--red)' : filled ? color : 'var(--border)'}`,
                      borderRadius: 8, padding: '6px 8px', fontSize: 13,
                      fontFamily: 'inherit', outline: 'none', textAlign: 'right',
                      background: filled ? '#fff' : '#fafafa',
                    }}
              ...
              <div className="bulk-mobile-row" style={{ padding: '10px 12px' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 8, alignItems: 'end' }}>
                  ...
                  <div>
                    ...
                    <div style={{
                      padding: '8px 8px', borderRadius: 8, background: filled ? bgColor : '#f5f5f5',
                      fontSize: 14, fontWeight: 700, color: filled ? color : 'var(--text-muted)',
                      textAlign: 'right', border: `1.5px solid ${filled ? color : 'var(--border)'}`,
                    }}>
                      {filled ? fmt(rowTotal(h.id)) : '—'}
                    </div>
                  </div>
      ...
      <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap' }}>
        <button className="btn btn-primary" onClick={() => handleSaveBulk(type)} disabled={saving || filledCount === 0}>
          {saving
            ...
            <table>
              ...
              <tbody>
                {Object.keys(getMonthSummary()).length === 0
                  ? <tr><td colSpan={8} style={{ textAlign: 'center', padding: '2rem', color: 'var(--text-muted)' }}>No data for this month.</td></tr>
